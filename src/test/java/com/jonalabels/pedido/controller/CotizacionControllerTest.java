...
class CotizacionControllerTest {
    ...
    void listarCotizaciones_retornaPaginaConStatus200() throws Exception {
        ...
        var cotizaciones = List.of(
                new CotizacionResponseDTO(1L, "María García", "5512345678", "maria@ejemplo.com", 5000, "Etiquetas de Satín", "5cm x 3cm", ahora, EstadoCotizacion.NUEVO, "https://res.cloudinary.com/demo.jpg"),
